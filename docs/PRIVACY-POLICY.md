# Política de Privacidade — UFS Dark Theme
...
O UFS Dark Theme não coleta, registra ou transmite dados pessoais ou sensíveis,
histórico de navegação, conteúdo de páginas, credenciais, dados de formulários,
comunicações, localização ou informações financeiras.
...
## Acesso aos sistemas institucionais
...
O UFS Dark Theme não compartilha, vende ou transfere dados de usuários a
terceiros e não utiliza dados para publicidade ou criação de perfis.

## Código e serviços externos
...
Solicitações sobre esta política podem ser enviadas pelo canal de suporte
informado na página do UFS Dark Theme na Chrome Web Store.
